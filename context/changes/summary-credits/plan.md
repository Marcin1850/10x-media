...
**As built: six migrations**, all additive, and **all live on the cloud project** (`ukbptccdffiigkdekzcn`) as of 2026-07-14 — local and remote histories match per `npx supabase migration list`, and the post-push privilege state is verified by `db dump`.
...
| `20260714140000_assert_least_privilege_functions.sql` | impl-review F2 gap | Function grants + default privileges; revokes `anon` on prod    |
