...
- [x] 1.5 Deliberate break: table-wide grant turns roster invariant and `content` probe red; reverted — 0218b35
- [x] 1.6 Existing local summaries still list normally in the dashboard — 0218b35
...
- [x] 2.5 Devtools PATCH round-trip returns 200 and `GET /api/summaries` shows the mark — 0218b35
...
- [x] 3.6 Mark / switch / clear each survive reload — 0218b35
- [x] 3.7 New summary appears unmarked — 0218b35
- [x] 3.8 Verdict click never toggles expansion; keyboard operates the group — 0218b35
- [x] 3.9 Rapid double-click ignored while saving; reload matches screen — 0218b35
- [x] 3.10 Network failure rolls back with inline error; later success clears it — 0218b35
- [x] 3.11 Summary deleted in another tab → card disappears on mark — 0218b35
- [x] 3.12 Layout holds at ~400px, light and dark — 0218b35
