...
| S-08 | persist-video-metadata    | see the video's thumbnail, title, channel, length, upload date and language next to a summary | S-01          | FR-006 (list legibility)      | proposed |
