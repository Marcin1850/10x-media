...
### S-07: Summary generation telemetry (latency + cost)

- **Outcome:** (observability) every saved summary records how long generation took and what the LLM call cost, so models, characters and transcript branches can be compared on speed and spend — not just on content.
