...
| S-04       | delete-account            | Delete account + all data (GDPR)               | impl_reviewed         | Both phases implemented + committed (2026-07-12); Workers Secret set. Manual E2E passed; impl-review ran — NEEDS ATTENTION (2 warnings, 3 observations); triage pending before Done. |
